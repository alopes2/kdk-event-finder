...
const genreRules = [
  ...
  ["African", /\bafro|africa|afrikan|amapiano|high-?life|afrobeats?|gqom\b/i],
  ["Latin", /\blatin|latinx|latein|latino|cumbia|tango|reggaeton|andes|andine|kolumb|peru|karib|caribbean\b/i],
